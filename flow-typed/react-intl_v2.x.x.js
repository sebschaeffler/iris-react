// https://github.com/marudor/flowInterfaces/blob/master/packages/iflow-react-intl/index.js.flow
...
declare module "react-intl" {
  ...
  declare class FormattedMessage extends React.Component<void, MessageDescriptor & {
    values?: Object, tagName?: string
  }, void> {}
  declare class FormattedHTMLMessage extends React.Component<void, DateTimeFormatOptions & {
    values?: Object, tagName?: string
  }, void> {}
  declare class FormattedDate extends React.Component<void, DateTimeFormatOptions & {
    value: $DateParseable, format?: string
  }, void> {}
  declare class FormattedTime extends React.Component<void, DateTimeFormatOptions & {
    value: $DateParseable, format?: string
  }, void> {}
  declare class FormattedRelative extends React.Component<void, RelativeFormatOptions & {
    value: $DateParseable, format?: string, updateInterval?: number, initialNow?: $DateParseable
  }, void> {}
  declare class FormattedNumber extends React.Component<void, NumberFormatOptions & {
    value: number | string, format?: string
  }, void> {}
  declare class FormattedPlural extends React.Component<void, PluralFormatOptions & {
    value: number | string, other: React.Component, zero?: React.Component, one?: React.Component,
    two?: React.Component, few?: React.Component, many?: React.Component
  }, void> {}
  declare class IntlProvider extends React.Component<void, IntlConfig & {
    children: React.Component, initialNow?: $DateParseable
  }, void> {}
