...
const mapStateToProps = (state) => {
  return {
    ...
    initialValues: state.subscriptions.newapi,
    isSuccessfullyCreated: state.subscriptions.isSuccessfullyCreated,
...
export default connect(mapStateToProps, { submitNewApp })(injectIntl(SubscriptionsCreateForm));
